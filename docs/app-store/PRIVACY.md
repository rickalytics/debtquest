...
| Name/player names | Local | Stored if entered | App functionality; linked to user; no tracking |
...
| Other user content | Notes/rewards remain local | Stored if entered | App functionality; linked to user; no tracking |
