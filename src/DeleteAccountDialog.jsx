  ...
  return (
    <div className="account-dialog-backdrop">
      ...
      >
        ...
        <p>
          This permanently deletes your login and cloud debt records, payments,
          progress, and rewards. Other devices using this account will lose
          access. Export a backup first if you want to keep a copy.
        </p>
        <label>
          Current password
          <input
