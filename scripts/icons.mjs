...
await sharp(source).flatten({ background: '#0a0a0f' }).png().toFile('ios/App/App/Assets.xcassets/AppIcon.appiconset/AppIcon-512@2x.png');
...
const splash = Buffer.from('<svg xmlns="http://www.w3.org/2000/svg" width="2732" height="2732"><path fill="#0a0a0f" d="M0 0h2732v2732H0z"/></svg>');
for(const name of ['splash-2732x2732.png','splash-2732x2732-1.png','splash-2732x2732-2.png']) {
  await sharp(splash).png().toFile(`ios/App/App/Assets.xcassets/Splash.imageset/${name}`);
}
