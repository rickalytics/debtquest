...
if (!["local", "cloud"].includes(env.VITE_DATA_MODE))
  throw new Error(
    "Choose local or cloud mode before generating the privacy manifest.",
  );
const collected =
...
console.log(
  `Privacy manifest generated for ${env.VITE_DATA_MODE} mode. Confirm provider practices before submission.`,
);
